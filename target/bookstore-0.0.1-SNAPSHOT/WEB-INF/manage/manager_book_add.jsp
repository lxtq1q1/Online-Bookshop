                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"  class="form-control" name="pirce" value="">
                                                </div>
                                            </div>
                                            <div class="line"></div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="printer" value="">
                                                </div>
                                            </div>
                                            <div class="line"></div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="Wdate" name="dateString"  onClick="WdatePicker()" type="date"/>
                                                </div>
                                            </div>
                                            <div class="line"></div>
                                            <div class="form-group row">
