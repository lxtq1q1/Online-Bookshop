    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">用户信息新增</h2>
                </div>
            </header>
            <%--<!-- Breadcrumb-->--%>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="" class="form-control" name="password" value="">
                                                </div>
                                            </div>
                                            <div class="line"></div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="i-checks">
                                                        <input id="radioCustom1" type="radio" value="男" name="gender" class="radio-template" />
                                                        <label for="radioCustom1">男</label>
                                                    </div>
                                                    <div class="i-checks">
                                                        <input id="radioCustom2" type="radio" value="女" name="gender" class="radio-template" />
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-4 offset-sm-3">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="submit" >Commit</button>
