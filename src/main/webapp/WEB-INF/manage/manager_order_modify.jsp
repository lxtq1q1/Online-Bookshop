    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <div class="content-inner">
            ...
            <header class="page-header">
                <div class="container-fluid">
                    <h2 class="no-margin-bottom">订单信息修改</h2>
                </div>
            </header>
            <%--<!-- Breadcrumb-->--%>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="oid" name="oid" value="${bookOrder.oid }" readonly>
                                                </div>
                                            </div>
                                            <div class="line"></div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 form-control-label">订购人姓名:</label>
                                                <div class="col-sm-9">
                                                    <input type="text"  class="form-control" id="oname" name="oname" value="${bookOrder.oname }">
                                                </div>
                                            </div>
                                            <div class="line"></div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 form-control-label">详细地址:</label>
                                                <div class="col-sm-9">
                                                    <input type="text"  class="form-control" id="address" name="address" value="${bookOrder.adress }">
                                                </div>
                                            </div>
                                            <div class="line"></div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="status" name="status" class="form-control mb-3">
                                                        <option value="未确认" <c:if test="${bookOrder.status=='未确认' }"> selected</c:if>>未确认</option>
                                                        <option value="未发货" <c:if test="${bookOrder.status=='未发货' }"> selected</c:if>>未发货</option>
                                                        <option value="已发货" <c:if test="${bookOrder.status=='已发货' }"> selected</c:if>>已发货</option>
                                                        <option value="已签收" <c:if test="${bookOrder.status=='已签收' }"> selected</c:if>>已签收</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="line"></div>
...
<%--js--%>
<script type="text/javascript" src="../../manager_index/js/manager_order_modify.js"></script>
